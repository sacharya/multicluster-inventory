...
const (
	...
	testSSKind               = "SyncSet"
	testRole                 = "role"
	testBMAAPIVersion        = "midas.io/v1alpha1"
	testSSOwnerRefAPIVersion = "hive.openshift.io/v1"
	testRoleLabel            = "metal3.io/role"
	testFinalizerLabel       = "baremetalasset.midas.io"
)
...
func TestReconcile(t *testing.T) {
	tests := []struct {
		...
		bma          *midasv1alpha1.BareMetalAsset
		...
		},
		{
			...
			existingObjs: []runtime.Object{
				func() *midasv1alpha1.BareMetalAsset {
					bma := NewBMA()
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			case "BareMetalAssetFound":
				...
				assert.True(t, conditionsv1.IsStatusConditionFalse(instance.Status.Conditions, midasv1alpha1.ConditionCredentialsFound))
			...
			case "BareMetalAssetNoClusterSpecfied":
				...
				assert.True(t, conditionsv1.IsStatusConditionTrue(instance.Status.Conditions, midasv1alpha1.ConditionCredentialsFound))
				...
				assert.True(t, conditionsv1.IsStatusConditionTrue(instance.Status.Conditions, midasv1alpha1.ConditionClusterDeploymentFound))
				...
				assert.True(t, conditionsv1.IsStatusConditionTrue(instance.Status.Conditions, midasv1alpha1.ConditionAssetSyncStarted))
				assert.True(t, conditionsv1.IsStatusConditionTrue(instance.Status.Conditions, midasv1alpha1.ConditionAssetSyncCompleted))
...
func TestCheckAssetSecret(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := rbma.checkAssetSecret(NewBMA(), log)
...
func TestEnsureLabels(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := rbma.ensureLabels(test.bma, log)
...
func TestCheckClusterDeployment(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectErr:    true,
			bma: func() *midasv1alpha1.BareMetalAsset {
				bma := NewBMAWithClusterDeployment()
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := rbma.checkClusterDeployment(test.bma, log)
			...
			if test.expectErr {
				...
				case "No cluster specified", "BMA With RelatedObjects":
					assert.True(t, conditionsv1.IsStatusConditionFalse(instance.Status.Conditions, midasv1alpha1.ConditionClusterDeploymentFound))

					assert.NotContains(t, instance.Status.Conditions, midasv1alpha1.ConditionAssetSyncStarted)
					assert.NotContains(t, instance.Status.Conditions, midasv1alpha1.ConditionAssetSyncCompleted)
...
func TestEnsureHiveSyncSet(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := rbma.ensureHiveSyncSet(NewBMAWithClusterDeployment(), log)
...
func TestCheckHiveSyncSetInstance(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := rbma.checkHiveSyncSetInstance(NewBMA(), log)
			...
			case "SyncSetInstanceNotFound", "UnexpectedResourceCount", "BareMetalHostResourceNotFound-Incorrect Kind",
				...
				assert.Error(t, err)
				assert.True(t, conditionsv1.IsStatusConditionFalse(instance.Status.Conditions, midasv1alpha1.ConditionAssetSyncCompleted))
...
func TestDeleteSyncSet(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := rbma.deleteSyncSet(test.bma, log)
			switch test.name {
...
func NewBMA() *midasv1alpha1.BareMetalAsset {
	return &midasv1alpha1.BareMetalAsset{
		...
		Spec: midasv1alpha1.BareMetalAssetSpec{
			BMC: midasv1alpha1.BMCDetails{
...
func NewBMAWithConditionAssetSyncStarted() *midasv1alpha1.BareMetalAsset {
	bma := NewBMA()
...
func NewBMAWithConditionAssetSyncStartedTrue() *midasv1alpha1.BareMetalAsset {
	bma := NewBMAWithConditionAssetSyncStarted()
	bma.Status.Conditions[0].Status = corev1.ConditionTrue
	return bma
}

func NewBMAWithConditionClusterDeploymentFound() *midasv1alpha1.BareMetalAsset {
	bma := NewBMA()
	bma.Status.Conditions = []conditionsv1.Condition{
		conditionsv1.Condition{
...
func NewBMAWithConditionClusterDeploymentFoundTrue() *midasv1alpha1.BareMetalAsset {
	bma := NewBMAWithConditionClusterDeploymentFound()
	bma.Status.Conditions[0].Status = corev1.ConditionTrue
	return bma
}

func NewBMAWithConditionClusterDeploymentFoundFalse() *midasv1alpha1.BareMetalAsset {
	bma := NewBMAWithConditionClusterDeploymentFound()
	bma.Status.Conditions[0].Status = corev1.ConditionFalse
	return bma
}

func NewBMAWithConditionCredentialsFound() *midasv1alpha1.BareMetalAsset {
	bma := NewBMA()
	bma.Status.Conditions = []conditionsv1.Condition{
		conditionsv1.Condition{
...
func NewBMAWithConditionCredentialsFoundTrue() *midasv1alpha1.BareMetalAsset {
	bma := NewBMAWithConditionCredentialsFound()
	bma.Status.Conditions[0].Status = corev1.ConditionTrue
	return bma
}

func NewBMAWithConditionCredentialsFoundFalse() *midasv1alpha1.BareMetalAsset {
	bma := NewBMAWithConditionCredentialsFound()
	bma.Status.Conditions[0].Status = corev1.ConditionFalse
	return bma
}

func NewBMAWithConditionAssetSyncCompleted() *midasv1alpha1.BareMetalAsset {
	bma := NewBMA()
	bma.Status.Conditions = []conditionsv1.Condition{
		conditionsv1.Condition{
...
func NewBMAWithConditionAssetSyncCompletedTrue() *midasv1alpha1.BareMetalAsset {
	bma := NewBMAWithConditionAssetSyncCompleted()
	bma.Status.Conditions[0].Status = corev1.ConditionTrue
	return bma
}

func NewBMAWithConditionAssetSyncCompletedFalse() *midasv1alpha1.BareMetalAsset {
	bma := NewBMAWithConditionAssetSyncCompleted()
	bma.Status.Conditions[0].Status = corev1.ConditionFalse
	return bma
}

func NewBMAWithRelatedObjects() *midasv1alpha1.BareMetalAsset {
	bma := NewBMA()
...
func NewBMAWithClusterDeployment() *midasv1alpha1.BareMetalAsset {
	bma := NewBMA()
